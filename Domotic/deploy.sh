...
EOF
    ...
    # Certificats pour tous les sous-domaines
    SUBDOMAINS="${SUBDOMAIN_API}.${DOMAIN},${SUBDOMAIN_GRAFANA}.${DOMAIN},${SUBDOMAIN_PHPMYADMIN}.${DOMAIN},${SUBDOMAIN_PORTAINER}.${DOMAIN},${SUBDOMAIN_NEXTCLOUD}.${DOMAIN},${SUBDOMAIN_LA4LDESDOMES}.${DOMAIN},${SUBDOMAIN_CAPITALOT}.${DOMAIN},${SUBDOMAIN_DAE_OPTIMIZZER}.${DOMAIN}"
